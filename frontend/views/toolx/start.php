...
<div class="container">
    <div class="row">
        <div class="col-lg-12 mb-4 pt-0">
            <p class="title1 font-inter-bold mb-4 text-muted text-center">ให้คุณตั้งใจฟัง และ<br>ทำตามคำสั่งเสียง<br>ที่ได้ยิน โดยเมื่อเริ่ม<br>การทดสอบแล้ว<br> จะมีเพียงคำสั่งเสียงเท่านั้น</p>
            <p class="title1 font-inter-bold mb-4 text-muted text-center">ให้คุณตอบคำถามแต่ละข้อ หลังจากได้ยินเสียงสัญญาณนี้</p>
            <p>
