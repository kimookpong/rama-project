...
$(function(){
        ...
        if (!('webkitSpeechRecognition' in window)) {
            ...
            recognition.onstart = function() {
                ...
                $('#instructions').html('กรุณาพูดช้าและชัดเจน'); // แสดงคำแนะนำ 
                $('#start_button').html('คลิ๊กเพื่อหยุด'); // เมื่อกดแล้วเปลี่ยนข้อความปุ่มเป็น คลิกอีกทีเพื่อหยุด หรือ Stop
            };
 
            recognition.onerror = function(event) {
                // ถ้าเกิดข้อผิดพลาด ทำงานส่วนนี้
                $('#instructions').html("มีข้อผิดพลาดในระบบ..."); // แจ้งสถานะถ้าเกิดข้อผิดพลาด
            };
            ...
            recognition.onend = function() {
                ...
                $('#start_button').html('คลิกเพื่อเริ่ม'); // เปลี่ยนข้อความปุ่มกดให้เป็นค่าเริ่มต้น
            };
...
//                console.log("final:    " + final_transcript);
                ...
                if(final_transcript.length > 0) { // นับความยาวข้อความ ถ้ามากกว่า 0 แสดงว่ามีค่า
                    ...
                    $('#transcriptHtml').append(final_transcript); // แสดงค่าใน textarea 
                }
            };
            ...
            $("#start_button").click(function(e) {
                ...
                if (recognizing) { // ภ้าทำงานอยู่ เมื่อกดก็จะเป็นหยุด
                    ...
                    $('#start_button').html('คลิ๊กเพื่อเริ่มใหม่อีกครั้ง'); // เปลี่ยนข้อความปุ่ม แนะนำกดใหม่ ถ้าต้องการจดจำเสียงอีกครั้ง
                   ...
                   // final_transcript = ''; // กำหนดตัวแปรเก็บข้อความเป็นค่าว่างก่อน
                    ...
                    $('#instructions').html('อนุญาตให้เบราว์เซอร์ใช้ไมโครโฟนของคุณ');
                    $('#start_button').html('รอสักครู่'); // เปลี่ยนข้อความปุ่ม ว่ารอ waiting
